...
export const ChevronRightIcon = ({ size = 8, className, disabled }: { size?: number; className?: string; disabled?: boolean }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 8 8"
  ...
  >
    <path
      ...
      fill="currentColor"
      fillOpacity={disabled ? 0.25 : 1}
    />
  </svg>
);

export const ChevronLeftIcon = ({ size = 8, className, disabled }: { size?: number; className?: string; disabled?: boolean }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 8 8"
...
export const ChevronsLeftIcon = ({ size = 8, className, disabled }: { size?: number; className?: string; disabled?: boolean }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 8 8"
...
export const ChevronsRightIcon = ({ size = 8, className, disabled }: { size?: number; className?: string; disabled?: boolean }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 8 8"
